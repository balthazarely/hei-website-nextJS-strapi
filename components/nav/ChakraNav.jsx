...
export default function WithSubnavigation() {
  ...
  return (
    <Box
      style={{ position: "fixed", width: "100%", top: 0, zIndex: 104 }}
      ...
      <Stack direction={"row"} align={"center"}>
        <Box>
          <Text
            ...
            fontWeight={500}
          >
            <NextLink href="/about">{label}</NextLink>
          </Text>
...
const NAV_ITEMS = [
  {
    ...
    children: [
      {
        label: "Pancratia Hall Lofts",
        href: "#",
      },
      {
        label: "Fruitdale School Lofts",
        href: "#",
      },
      {
        label: "FEiber Village at Garrison Station",
        href: "#",
      },
      {
        label: "Hangar 2 Lowry",
        href: "#",
      },
      {
        label: "Steam Plant Lofts",
        href: "#",
      },
      {
        label: "Steam Plant Row Homes",
        href: "#",
      },
      {
        label: "Innovage Headquarters",
        href: "#",
      },
      {
        label: "Courtyard by Marriott Hotel",
        href: "#",
      },
      {
        label: "Boston Lofts",
